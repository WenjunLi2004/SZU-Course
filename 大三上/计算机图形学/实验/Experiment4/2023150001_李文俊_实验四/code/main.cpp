...
void init()
{
	...
	// 设置物体的旋转位移
	table->setTranslation(glm::vec3(-0.5, 0.1, 0.0));
	...
	// 设置物体的旋转位移
	wawa->setTranslation(glm::vec3(0.5, 0.1, 0.0));
...
int main(int argc, char** argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(600, 600, "2023150001-李文俊-实验四", NULL, NULL);
	if (window == NULL)
	{
